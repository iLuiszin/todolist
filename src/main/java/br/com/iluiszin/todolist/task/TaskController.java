package br.com.iluiszin.todolist.task;
...
import br.com.iluiszin.todolist.utils.Utils;
...
public class TaskController {
    ...
    public ResponseEntity update(@RequestBody TaskModel taskModel, @PathVariable UUID id, HttpServletRequest request) {
        ...
        if (task.getIdUser() == null || !task.getIdUser().equals(request.getAttribute("idUser"))) {
